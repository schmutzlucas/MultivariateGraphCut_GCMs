...
plan(multicore, workers = future::availableCores())  # Set up parallel backend with 8 workers
...
saveRDS(list( ranges = final_ranges), 'ranges/range_var_final_ERA5_1950-2023_3v.rds')
